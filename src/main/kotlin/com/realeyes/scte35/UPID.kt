...
class UPID (val t:Int, val bytes:UByteArray) {
      ...
      companion object {
         fun withOrdinal(o:Int) : Type {
            return when (o) {
               ...
               else -> throw IllegalArgumentException("Unknown UPID type 0x%x.".format(o))
            }
         }
      }
   }
   ...
   /**
    * Returns [bytes] interpreted as a UTF-8 string.
    *
